...
const Settings = () => {
  ...
  return <div className="Settings flex justify-content-center gap-5">
      ...
      <div className={`setting-menu absolute top-16 right-4 bg-white shadow-lg rounded-lg p-4 z-50 transition-all duration-300 ${openSettings ? "opacity-100 scale-100 visible" : "opacity-0 scale-95 invisible"}`}>
