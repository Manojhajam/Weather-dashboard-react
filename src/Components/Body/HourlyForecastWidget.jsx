...
const HourlyForecastWidget = hourlydata => {
  ...
  return <div className="hourly hover:scale-[1.05] transition-transform duration-300 hover:shadow-2xl relative widget flex flex-col items-center justify-between p-4 bg-white  rounded-2xl border border-gray-300 dark:border-gray-700 shadow-md min-w-[120px] mt-2">
