...
const HourlyForecastWidget = (hourlydata) => {
  ...
  //date format  
  const now_date = { day: new Intl.DateTimeFormat(navigator.language, {
      weekday: "short",
      day: "2-digit",
      month: "2-digit"
  }).format(new Date()),
  ...
  const weather_date = { day: new Intl.DateTimeFormat(navigator.language, {
      weekday: "short",
      day: "2-digit",
      month: "2-digit"
  ...
  return <div className="relative widget flex flex-col items-center justify-between p-4 bg-white  rounded-2xl border border-gray-300 dark:border-gray-700 shadow-md min-w-[120px] mt-2">
      ...
      <div className="wind flex">
        <div className="speed">
          {Math.round(wind.speed)} {units.wind_speed}mm/h
        </div>
